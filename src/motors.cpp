...
void Motors::forward() {
  ...
  analogWrite(_leftMotorSpeedPin, (_maxLeftForwardSpeed+23));
...
void Motors::backward() {
  ...
  analogWrite(_leftMotorSpeedPin, (((_maxLeftBackwardSpeed)*87)/100));          // speed of left motor
  digitalWrite(_rightMotorDirectionPin, LOW);                      // direction of right motor
  analogWrite(_rightMotorSpeedPin, (((_maxRightBackwardSpeed)*99)/100));    // speed of left motor
}

void Motors::backward(int speed) {
  digitalWrite(_leftMotorDirectionPin, LOW);                       // direction of left motor
  analogWrite(_leftMotorSpeedPin, _maxLeftBackwardSpeed*(speed));          // speed of left motor
  digitalWrite(_rightMotorDirectionPin, LOW);                      // direction of right motor
  analogWrite(_rightMotorSpeedPin, _maxRightBackwardSpeed*(speed));    // speed of left motor
}
...
void Motors::zeroLeft(int speed) {
  digitalWrite(_leftMotorDirectionPin, LOW);                      // direction of left motor
  analogWrite(_leftMotorSpeedPin, _maxLeftForwardSpeed*(speed));       // speed of left motor
  digitalWrite(_rightMotorDirectionPin, HIGH);                     // direction of right motor
  analogWrite(_rightMotorSpeedPin, _maxRightForwardSpeed*(speed));         // speed of right motor
...
void Motors::zeroRight(int speed) {
  digitalWrite(_leftMotorDirectionPin, HIGH);                      // direction of left motor
  analogWrite(_leftMotorSpeedPin, _maxLeftForwardSpeed*(speed));           // speed of left motor
  digitalWrite(_rightMotorDirectionPin, LOW);                      // direction of right motor
  analogWrite(_rightMotorSpeedPin, _maxRightBackwardSpeed*(speed));         // speed of right motor
}
...
void Motors::right() {
  ...
  analogWrite(_leftMotorSpeedPin, _maxLeftForwardSpeed);           // speed of left motor
  digitalWrite(_rightMotorDirectionPin, HIGH);                     // direction of right motor
  analogWrite(_rightMotorSpeedPin, (_maxRightForwardSpeed+77)); // speed of right motor * 0.7 to initiate turn
}

void Motors::left() {
  digitalWrite(_leftMotorDirectionPin, HIGH);                      // direction of left motor
  analogWrite(_leftMotorSpeedPin, (_maxLeftForwardSpeed+77));       // speed of left motor * 0.7 to initiate turn
  digitalWrite(_rightMotorDirectionPin, HIGH);                     // direction of right motor
  analogWrite(_rightMotorSpeedPin, _maxRightForwardSpeed);         // speed of right motor
}
